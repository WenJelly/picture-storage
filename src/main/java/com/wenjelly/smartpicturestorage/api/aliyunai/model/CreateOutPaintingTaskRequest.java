...
public class CreateOutPaintingTaskRequest {
    ...
    // 打上了 Hutool 工具类的 @Alias 注解，这个注解仅对 Hutool 的 JSON 转换生效，对 SpringMVC 的 JSON 转换没有任何影响。
    @Data
    public static class Parameters implements Serializable {
         ...
         */
        @Alias("x_scale")
        // 经过测试发现，前端如果传递参数名 xScale，是无法赋值给 xScale 字段的；但是传递参数名 xscale，就可以赋值。这是因为 SpringMVC 对于第二个字母是大写的参数无法映射
