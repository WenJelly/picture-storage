...
import com.wenjelly.smartpicturestorage.api.aliyunai.AliYunAiApi;
...
import com.wenjelly.smartpicturestorage.api.imagesearch.ImageSearchApiFacade;
...
import com.wenjelly.smartpicturestorage.manager.auth.SpaceUserAuthManager;
import com.wenjelly.smartpicturestorage.manager.auth.StpKit;
import com.wenjelly.smartpicturestorage.manager.auth.annotation.SaSpaceCheckPermission;
import com.wenjelly.smartpicturestorage.manager.auth.model.SpaceUserPermissionConstant;
...
import com.wenjelly.smartpicturestorage.model.vo.picutre.PictureTagCategory;
...
//            }
    ...
    public BaseResponse<List<PictureVO>> getHomeCarousel() {
        // 获取轮播图
        List<PictureVO> pictureVOList = pictureService.getHomePageBanner();
        return ResultUtils.success(pictureVOList);
    }
}
